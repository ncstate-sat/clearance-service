...
class Clearance:
    ...
    def __init__(
        self, _id: str, ccure_id: Optional[str] = None, name: Optional[str] = None
    ) -> None:
        """
        Parameters:
    ...
    def get(query: Optional[str] = "") -> list["Clearance"]:
        ...
        return [
            Clearance(_id=clearance.get("GUID", ""), name=clearance.get("Name", ""))
    ...
    def get_by_guids(guids: list[str]) -> list[dict]:
        ...
        return [
            {"guid": clearance["GUID"], "id": clearance["ObjectID"], "name": clearance["Name"]}
            for clearance in clearances
        ]
    ...
    @classmethod
    def verify_permission(cls, clearance_id: str, campus_id: str) -> bool:
        """
        ...
        """
        allowed_guids = map(lambda clearance: clearance.id, cls.get_allowed(campus_id))
